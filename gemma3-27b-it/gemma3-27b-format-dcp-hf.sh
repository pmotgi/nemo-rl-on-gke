...
WORLD_SIZE=8
DISTRIBUTED_CHECKPOINT_PATH="/data/nemo_rl_gemma3_25b_2_27" #Source Path of the NemoRL Distrbuted checkpoint
HUGGINGFACE_CHECKPOINT_PATH="/data/nemo_rl_gemma3_25b_2_27/hf2-28" #Destination path for converted HF Checkpoint
